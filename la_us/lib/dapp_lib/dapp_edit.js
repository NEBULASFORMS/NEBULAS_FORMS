...
function Edit_Onload(status, key, value) {
    if (status == 1) {
        ...
        if (key.length == 20 && value.length == 20) {
            Restore_Remind_Type1_Open("Data is being restored...", key, value);
        }
        else {
            Restore_Remind_Type2_Open("The address is wrong, please check your link");
        }
    }
    else {
        Restore_Remind_Type2_Open("Error: Please check your link");
    }
...
function ToHTML_MainTitle(object) {
    ...
    if (object.EditStatus) {
        ...
        string += "<div class=\"form_EditMainTitle_tile\"><label>MainTitle:</label><input id=\"form_EditMainTitle_tile\" type=\"text\" maxlength=\"" + object.Title_Count + "\" value=\"" + object.Title + "\" onblur=\"OnBlur_MainTitle()\" /></div>";
        string += "<div class=\"form_EditMainTitle_content\"><label>Introduction:</label><textarea id=\"form_EditMainTitle_content\" maxlength=\"" + object.Content_Count + "\" onblur=\"OnBlur_MainTitle()\" >" + object.Content + "</textarea></div>";
        string += "</div>";
    }
    else {
...
function ToHTML_Multiple(object) {
    ...
    string += "<div class=\"form_Project__Head_Type\"><label id=\"form_Project_" + object.Coding + "_Head_Type\">" + object.No + ": Checkboxes" + GetMultipleNumString(object) + "</label></div>";
    if (object.EditStatus) string += "<div class=\"form_Project__Head_Del\" title=\"Delete\" onmousedown=\"button_OnClick_Del_down()\" onmousemove=\"button_OnClick_Del_move()\" onmouseout=\"button_OnClick_Del_out()\" onmouseup=\"button_OnClick_Del_up(" + object.Coding + ")\"></div>";
    string += "</div>";
...
function ToHTML_Single(object) {
    ...
    string += "<div class=\"form_Project__Head\">";
    string += "<div class=\"form_Project__Head_Type\"><label id=\"form_Project_" + object.Coding + "_Head_Type\">" + object.No + ": Multiple</label ></div > ";
    if (object.EditStatus) string += "<div class=\"form_Project__Head_Del\" title=\"Delete\" onmousedown=\"button_OnClick_Del_down()\" onmousemove=\"button_OnClick_Del_move()\" onmouseout=\"button_OnClick_Del_out()\" onmouseup=\"button_OnClick_Del_up(" + object.Coding + ")\"></div>";
    string += "</div>";
...
function ToHTML_Text(object) {
    ...
    string += "<div class=\"form_Project__Head\">";
    string += "<div class=\"form_Project__Head_Type\"><label id=\"form_Project_" + object.Coding + "_Head_Type\">" + object.No + ": Question</label></div>";
    if (object.EditStatus) string += "<div class=\"form_Project__Head_Del\" title=\"Delete\" onmousedown=\"button_OnClick_Del_down()\" onmousemove=\"button_OnClick_Del_move()\" onmouseout=\"button_OnClick_Del_out()\" onmouseup=\"button_OnClick_Del_up(" + object.Coding + ")\"></div>";
    string += "</div>";
    ...
    string += "<div class=\"form_Project_Text_text\"><label>Content:</label><textarea id=\"form_Project_" + object.Coding + "_Text_text\" maxlength=\"" + object.Text_Max + "\">" + object.Text + "</textarea></div>";
    string += "</div>";
    string += "</div>";
    return string;
}
...
function ToHTML_Edit_Multiple() {
    var string = "";
    string += "<div class=\"edit_Edit_Heading\"><div class=\"edit_Edit_Heading_Type\" ><label>" + Edit.No + " : Checkboxes</label></div></div>";
    string += "<div class=\"edit_Edit_Title\"><label>Title:</label><textarea id=\"edit_Edit_Title\" maxlength=\"125\" onblur=\"OnBlur_Multiple()\">" + Edit.Title + "</textarea></div>";
    ...
    for (var i = 0; i < Edit.Option_Num; i++) {
        string += "<div id=\"edit_Edit_Multiple_Option_" + (i + 1) + "\" class=\"edit_Edit_Multiple_Option\"><label>Option " + GetOptionName(i + 1) + ":</label><input id=\"edit_Edit_Multiple_Option_" + (i + 1) + "_value\" type=\"text\" value=\"" + Edit.Option[i] + "\" onblur=\"OnBlur_Multiple()\"/></div>";
    }
    string += "<div id=\"edit_Edit_Multiple_OptionButton\" class=\"edit_Edit_Multiple_OptionButton\">";
    string += "<input class=\"edit_Edit_Multiple_OptionButton_Add\" title=\"Add\" type=\"button\" value=\"+\" onmousedown=\"button_MultipleEditAdd_down()\" onmousemove=\"button_MultipleEditAdd_move()\" onmouseout=\"button_MultipleEditAdd_out()\" onmouseup=\"button_MultipleEditAdd_up()\"/>";
    string += "<input class=\"edit_Edit_Multiple_OptionButton_Del\" title=\"Delete\" type=\"button\" value=\"-\" onmousedown=\"button_MultipleEditDel_down()\" onmousemove=\"button_MultipleEditDel_move()\" onmouseout=\"button_MultipleEditDel_out()\" onmouseup=\"button_MultipleEditDel_up()\"/>";
    string += "</div>";
    string += "<div class=\"edit_Edit_Multiple_OptionNum\"><label>Related Setting:</label></div>";
    string += "<div class=\"edit_Edit_Multiple_Num_Min\"><label>Options Min:</label><input  id=\"edit_Edit_Multiple_Num_Min_value\" value=\"" + Edit.Option_Min + "\" type=\"text\" /><div class=\"edit_Edit_Multiple_Num_Min_div\"></div>";
    ...
    string += "</div>";
    string += "<div class=\"edit_Edit_Multiple_Num_Max\"><label>Options Max:</label><input  id=\"edit_Edit_Multiple_Num_Max_value\" value=\""+Edit.Option_Max+"\" type=\"text\" /><div class=\"edit_Edit_Multiple_Num_Max_div\"></div>";
...
function ToHTML_Edit_Single() {
    var string = "";
    string += "<div class=\"edit_Edit_Heading\"><div class=\"edit_Edit_Heading_Type\" ><label>" + Edit.No + " : Multiple</label></div></div>";
    string += "<div class=\"edit_Edit_Title\"><label>Title:</label><textarea id=\"edit_Edit_Title\" maxlength=\"125\" onblur=\"OnBlur_Single()\">" + Edit.Title + "</textarea></div>";
    string += "<div class=\"edit_Edit_Single\">";
    string += "<div id=\"edit_Edit_Single_Options\" class=\"edit_Edit_Single_Options\">";
    for (var i = 0; i < Edit.Option_Num; i++) {
        string += "<div id=\"edit_Edit_Single_Option_" + (i + 1) + "\" class=\"edit_Edit_Single_Option\"><label>Option " + GetOptionName(i + 1) + ":</label><input id=\"edit_Edit_Single_Option_" + (i + 1) + "_value\" type=\"text\" value=\"" + Edit.Option[i] + "\"  onblur=\"OnBlur_Single()\" /></div>";
    }
    string += "<div id=\"edit_Edit_Single_OptionButton\" class=\"edit_Edit_Single_OptionButton\">";
    string += "<input class=\"edit_Edit_Single_OptionButton_Add\" title=\"Add\" type=\"button\" value=\"+\" onmousedown=\"button_SingleEditAdd_down()\" onmousemove=\"button_SingleEditAdd_move()\" onmouseout=\"button_SingleEditAdd_out()\" onmouseup=\"button_SingleEditAdd_up()\"/>";
    string += "<input class=\"edit_Edit_Single_OptionButton_Del\" title=\"Delete\" type=\"button\" value=\"-\" onmousedown=\"button_SingleEditDel_down()\" onmousemove=\"button_SingleEditDel_move()\" onmouseout=\"button_SingleEditDel_out()\" onmouseup=\"button_SingleEditDel_up()\"/>";
    string += "</div>";
    string += "</div>";
    string += "</div>";
    return string;
...
function ToHTML_Edit_Text() {
    var string = "";
    string += "<div class=\"edit_Edit_Heading\"><div class=\"edit_Edit_Heading_Type\" ><label>" + Edit.No + " : Question</label></div></div>";
    string += "<div class=\"edit_Edit_Title\"><label>Title:</label><textarea id=\"edit_Edit_Title\" maxlength=\"125\" onblur=\"OnBlur_Text()\">" + Edit.Title + "</textarea></div>";
    string += "<div class=\"edit_Edit_Text\">";
    string += "<label>Defaults:</label><textarea id=\"edit_Edit_Text\" onblur=\"OnBlur_Text()\">" + Edit.Text + "</textarea>";
    string += "</div>";
    return string;
}
function ToHTML_NoEdit() {
    return "<div class=\"edit_NoEdit\"><div class=\"edit_NoEdit_Text\"><label>Click on the item to edit the property.</label></div></div>";
}
...
function HTML_Updata() {
    ...
    string += "</div>";
    string += "<div class=\"form_button_submit\"><input id=\"button_submit\" type=\"button\" value=\"Submit\" onmousedown=\"button_sumbit_down()\" onmousemove=\"button_sumbit_move()\" onmouseout=\"button_sumbit_out()\" onmouseup=\"button_sumbit_up()\" /></div>";
...
function HTML_UpdataNo() {
    for (var i = 1; i < Form.length; i++) {
        Form[i].No = i;
        if (Form[i].Type == 1) document.getElementById("form_Project_" + Form[i].Coding + "_Head_Type").innerHTML = Form[i].No + ": Checkboxes";
        else if (Form[i].Type == 2) document.getElementById("form_Project_" + Form[i].Coding + "_Head_Type").innerHTML = Form[i].No + ": Multiple";
        else if (Form[i].Type == 3) document.getElementById("form_Project_" + Form[i].Coding + "_Head_Type").innerHTML = Form[i].No + ": Question";
    }
}
...
function OnClick_Del(coding) {
    ...
    if (result == "") {
        document.getElementById("Remind_pane_mess").innerHTML = "Error: Failed to invoke contract";
        document.getElementById("Remind_pane").innerHTML += "<div class=\"Remind_pane_Button\"><input value=\"Exit\" type=\"button\" onmousedown=\"button_Restore_Remind_Type2_dowm()\" onmousemove=\"button_Restore_Remind_Type2_move()\" onmouseout=\"button_Restore_Remind_Type2_out()\" onmouseup=\"button_Restore_Remind_Type2_up()\"/></div>";
    }
    else {
        try {
            result = JSON.parse(result)
        } catch (err) {
            document.getElementById("Remind_pane_mess").innerHTML = "JSON Error:" + err;
            document.getElementById("Remind_pane").innerHTML += "<div class=\"Remind_pane_Button\"><input value=\"Exit\" type=\"button\" onmousedown=\"button_Restore_Remind_Type2_dowm()\" onmousemove=\"button_Restore_Remind_Type2_move()\" onmouseout=\"button_Restore_Remind_Type2_out()\" onmouseup=\"button_Restore_Remind_Type2_up()\"/></div>";
        }
        if (result.Value) {
            if (result.True) {
                document.getElementById("Remind_pane_mess").innerHTML = "There is a mistake in the contract. Please contact us";
                document.getElementById("Remind_pane").innerHTML += "<div class=\"Remind_pane_Button\"><input value=\"Exit\" type=\"button\" onmousedown=\"button_Restore_Remind_Type2_dowm()\" onmousemove=\"button_Restore_Remind_Type2_move()\" onmouseout=\"button_Restore_Remind_Type2_out()\" onmouseup=\"button_Restore_Remind_Type2_up()\"/></div>";
            }
            else {
                document.getElementById("Remind_pane_mess").innerHTML = result.Type + ":" + result.Value + "," + result.Info_US;
                document.getElementById("Remind_pane").innerHTML += "<div class=\"Remind_pane_Button\"><input value=\"Exit\" type=\"button\" onmousedown=\"button_Restore_Remind_Type2_dowm()\" onmousemove=\"button_Restore_Remind_Type2_move()\" onmouseout=\"button_Restore_Remind_Type2_out()\" onmouseup=\"button_Restore_Remind_Type2_up()\"/></div>";
            }
        }
        else if (result.Key) {
            ...
            document.getElementById("Remind_pane_mess").innerHTML = "Error:" + result;
            document.getElementById("Remind_pane").innerHTML += "<div class=\"Remind_pane_Button\"><input value=\"Exit\" type=\"button\" onmousedown=\"button_Restore_Remind_Type2_dowm()\" onmousemove=\"button_Restore_Remind_Type2_move()\" onmouseout=\"button_Restore_Remind_Type2_out()\" onmouseup=\"button_Restore_Remind_Type2_up()\"/></div>";
        }
    }
}
    function Restore_Remind_Type2_Open(str) {
        ...
        string += "<div class=\"Remind_pane_Head\"></div>";
        string += "<div class=\"Remind_pane_mess\"><label id=\"Remind_pane_mess\">" + str + "</label></div>";
        string += "<div class=\"Remind_pane_Button\"><input value=\"Exit\" type=\"button\" onmousedown=\"button_Restore_Remind_Type2_dowm()\" onmousemove=\"button_Restore_Remind_Type2_move()\" onmouseout=\"button_Restore_Remind_Type2_out()\" onmouseup=\"button_Restore_Remind_Type2_up()\"/></div>";
        string += "</div>";
    ...
    function button_sumbit_up() {
        ...
        string += "<div class=\"Form_Submit_pane_mess\"><label id=\"Form_Submit_pane_mess\">Do you want to submit a project?</label></div>";
        string += "<div id=\"Form_Submit_pane_BackYes\" class=\"Form_Submit_pane_BackYes\"><input value=\"Yes\" type=\"button\" onmousedown=\"button_Form_SubmitYes_down()\" onmousemove=\"button_Form_SubmitYes_move()\" onmouseout=\"button_Form_SubmitYes_out()\" onmouseup=\"button_Form_SubmitYes_up()\"/></div>";
        string += "<div id=\"Form_Submit_pane_BackNo\" class=\"Form_Submit_pane_BackNo\"><input value=\"No\" type=\"button\" onmousedown=\"button_Form_SubmitNo_down()\" onmousemove=\"button_Form_SubmitNo_move()\" onmouseout=\"button_Form_SubmitNo_out()\" onmouseup=\"button_Form_SubmitNo_up()\"/></div>";
        string += "</div>";
...
function button_Form_SubmitYes_up() {
    ...
    if (Project_OwnKeys) {
        WalletUsed = true;
        document.getElementById("Form_Submit_pane_mess").innerHTML = "<div class=\"None_Select\">Start submitting the project<br><br>We will apply to call your wallet</div>";
        document.getElementById("Form_Submit_pane").innerHTML += "<div id=\"Form_Submit_pane_Back\" class=\"Form_Submit_pane_Back\"><input value=\"Exit\" type=\"button\" onmousedown=\"button_Form_SubmitBack_down()\" onmousemove=\"button_Form_SubmitBack_move()\" onmouseout=\"button_Form_SubmitBack_out()\" onmouseup=\"button_Form_SubmitBack_Plus_1_up()\"/></div>";
            ...
            nebPay.queryPayInfo(SerialNumber).then(function (resp) {
                if (WalletUsed) {
                    ...
                    if (respObject.code === 0) {                      
                        WalletUsed = false;
                        document.getElementById("Form_Submit_pane_mess").innerHTML = "<div class=\"None_Select\">The upload of data is successful. Please keep the following information in a safe place.<br>Later you can use it for related operations.</div><br>Number : " + Project_Key + "<br>Pass : " + Project_Pass;
                        document.getElementById("Form_Submit_pane").innerHTML += "<div id=\"Form_Submit_pane_Back\" class=\"Form_Submit_pane_Back\"><input value=\"Exit\" type=\"button\" onmousedown=\"button_Form_SubmitBack_down()\" onmousemove=\"button_Form_SubmitBack_move()\" onmouseout=\"button_Form_SubmitBack_out()\" onmouseup=\"button_Form_SubmitBack_Plus_2_up()\"/></div>";
                        EditStatus = false;
                        clearInterval(Query);
                    }
                }
                ...
                document.getElementById("Form_Submit_pane_mess").innerHTML = "<div class=\"None_Select\">We seem to have encountered some errors<br><br>You can save it later</div>";
                    document.getElementById("Form_Submit_pane").innerHTML += "<div id=\"Form_Submit_pane_Back\" class=\"Form_Submit_pane_Back\"><input value=\"Exit\" type=\"button\" onmousedown=\"button_Form_SubmitBack_down()\" onmousemove=\"button_Form_SubmitBack_move()\" onmouseout=\"button_Form_SubmitBack_out()\" onmouseup=\"button_Form_SubmitBack_Plus_2_up()\"/></div>";
                });
        }
        function button_Form_SubmitYes_up_Listener() {
            $("div").remove("#Form_Submit_pane_Back");
            document.getElementById("Form_Submit_pane_mess").innerHTML = "<div class=\"None_Select\">Project is being saved<br><br>Please wait...</div>";
        }
        
    }
    else {
        document.getElementById("Form_Submit_pane_mess").innerHTML = "<div class=\"None_Select\">You have no project key detected<br><br>Please return to get the corresponding information</div>";
        document.getElementById("Form_Submit_pane").innerHTML += "<div id=\"Form_Submit_pane_Back\" class=\"Form_Submit_pane_Back\"><input value=\"OK\" type=\"button\" onmousedown=\"button_Form_SubmitBack_down()\" onmousemove=\"button_Form_SubmitBack_move()\" onmouseout=\"button_Form_SubmitBack_out()\" onmouseup=\"button_Form_SubmitBack_up()\"/></div>";
    }
}
...
function button_Form_SubmitBack_Plus_1_up() {
    ...
    WalletUsed = false;
    document.getElementById("Form_Submit_pane_mess").innerHTML = "<br><br>Exiting, Please wait..."
    $("div").remove("#Form_Submit_pane_Back");
}
function button_Form_SubmitBack_Plus_2_up() {
    ...
    function button_MultipleEditAdd_up() {
        ...
        if (Edit.Option_Num == 25) { }
            ...
            option_insert.innerHTML = "<label>Option " + GetOptionName(Edit.Option_Num) + ":</label><input id=\"" + option_insert.id + "_value\" type=\"text\" onblur=\"OnBlur_Multiple()\"/>";
    ...
    function button_SingleEditAdd_up() {
        ...
        if (Edit.Option_Num == 25) { }
            ...
            option_insert.innerHTML = "<label>Option " + GetOptionName(Edit.Option_Num) + ":</label><input id=\"" + option_insert.id + "_value\" type=\"text\" onblur=\"OnBlur_Single()\"/>";
        ...
        if (Edit == null) { }
            ...
            if (Form[index].Type == 1) {
                ...
                for (var i = 0; i < Form[index].Option_Num; i++) {
                    if (Form[index].Option[i] == "") Form[index].Option[i] = "Unfilled";
                }
            }
    ...
    document.getElementById("form_Project_" + Edit.Coding + "_Head_Type").innerHTML = Edit.No + ": Checkboxes" + GetMultipleNumString(Edit);
    var string = "";
    string += "<div id=\"form_Project_" + Edit.Coding + "_Multiple_title\" class=\"form_Project_Multiple_title\"><label>" + Edit.Title + "</label></div>";
    for (var i = 0; i < Edit.Option_Num; i++) {
        string += "<div id=\"form_Project_" + Edit.Coding + "_option_" + (i + 1) + "\" class=\"form_Project_Multiple_option\">";
    ...
    var contract = {
        ...
        document.getElementById("add_Heading_KeyInfo_Value").innerHTML = "Processing..."
        document.getElementById("add_Heading_Password_Value").innerHTML = "Processing...";
    neb.api.call(from, dappAddress, value, nonce, gas_price, gas_limit, contract).then(function (resp) {
    ...
    var result = resp.result;
    if (result == "") {
        document.getElementById("add_Heading_KeyInfo_Value").innerHTML = "Error: Failed to invoke contract";
    }
    else {
        try {
            result = JSON.parse(result)
        } catch (err) {
            document.getElementById("add_Heading_KeyInfo_Value").innerHTML = "JSON Error:" + err;
        }
        if (result.Key) {
            Project_Key = result.Key;
            Project_Pass = result.Pass;
            ...
            document.getElementById("add_Heading_KeyInfo_Value").innerHTML = "Error:" + result;
        }
    }
}
    ...
    function button_Top_Back_up() {
        ...
        if (EditStatus) {
            ...
            string += "<div class=\"back_preview_pane_mess\"><label>Project not saved yet, whether to exit?</label></div>";
            string += "<div class=\"back_preview_pane_BackYes\"><input value=\"Yes\" type=\"button\" onmousedown=\"button_Top_BackYes_down()\" onmousemove=\"button_Top_BackYes_move()\" onmouseout=\"button_Top_BackYes_out()\" onmouseup=\"button_Top_BackYes_up()\"/></div>";
            string += "<div class=\"back_preview_pane_BackNo\"><input value=\"No\" type=\"button\" onmousedown=\"button_Top_BackNo_down()\" onmousemove=\"button_Top_BackNo_move()\" onmouseout=\"button_Top_BackNo_out()\" onmouseup=\"button_Top_BackNo_up()\"/></div>";
            string += "</div>";
    ...
    function button_Top_Upload_up() {
        ...
        if (EditStatus) {
            ...
            string += "<div  class=\"Form_Upload_pane_mess\"><label id=\"Form_Upload_pane_mess\">Do you want to submit a project?</label></div>";
            string += "<div id=\"Form_Upload_pane_BackYes\" class=\"Form_Upload_pane_BackYes\"><input value=\"Yes\" type=\"button\" onmousedown=\"button_Form_UploadYes_down()\" onmousemove=\"button_Form_UploadYes_move()\" onmouseout=\"button_Form_UploadYes_out()\" onmouseup=\"button_Form_UploadYes_up()\"/></div>";
            string += "<div id=\"Form_Upload_pane_BackNo\" class=\"Form_Upload_pane_BackNo\"><input value=\"No\" type=\"button\" onmousedown=\"button_Form_UploadNo_down()\" onmousemove=\"button_Form_UploadNo_move()\" onmouseout=\"button_Form_UploadNo_out()\" onmouseup=\"button_Form_UploadNo_up()\"/></div>";
            string += "</div>";
    ...
    $("div").remove("#Form_Upload_pane_BackYes");
        ...
        if (Project_OwnKeys) {
            WalletUsed = true;
            document.getElementById("Form_Upload_pane_mess").innerHTML = "Start submitting the project<br><br>We will apply to call your wallet";
            document.getElementById("Form_Upload_pane").innerHTML += "<div id=\"Form_Upload_pane_Back\" class=\"Form_Upload_pane_Back\"><input value=\"Exit\" type=\"button\" onmousedown=\"button_Form_UploadBack_down()\" onmousemove=\"button_Form_UploadBack_move()\" onmouseout=\"button_Form_UploadBack_out()\" onmouseup=\"button_Form_UploadBack_Plus_1_up()\"/></div>";
            ...
            function button_Form_UploadYes_up_Query() {
                nebPay.queryPayInfo(SerialNumber).then(function (resp) {
                    if (WalletUsed) {
                        ...
                        if (respObject.code === 0) {
                            WalletUsed = false;
                            document.getElementById("Form_Upload_pane_mess").innerHTML = "<div class=\"None_Select\">The upload of data is successful. Please keep the following information in a safe place.<br>Later you can use it for related operations.</div><br>Number : " + Project_Key + "<br>Pass : " + Project_Pass;
                            document.getElementById("Form_Upload_pane").innerHTML += "<div id=\"Form_Upload_pane_Back\" class=\"Form_Upload_pane_Back\"><input value=\"Exit\" type=\"button\" onmousedown=\"button_Form_UploadBack_down()\" onmousemove=\"button_Form_UploadBack_move()\" onmouseout=\"button_Form_UploadBack_out()\" onmouseup=\"button_Form_UploadBack_Plus_2_up()\"/></div>";
                            EditStatus = false;
                            clearInterval(Query);
                        }
                    }
                    ...
                    document.getElementById("Form_Upload_pane_mess").innerHTML = "<div class=\"None_Select\">We seem to have encountered some errors<br><br>You can save it later</div>";
                });
            }
            function button_Form_UploadYes_up_Listener() {
                $("div").remove("#Form_Upload_pane_Back");
                document.getElementById("Form_Upload_pane_mess").innerHTML = "<div class=\"None_Select\">Project is being saved<br><br>Please wait...</div>";
            }
        }
        else {
            document.getElementById("Form_Upload_pane_mess").innerHTML = "<div class=\"None_Select\">You have no project key detected<br><br>Please return to get the corresponding information</div>";
            document.getElementById("Form_Upload_pane").innerHTML += "<div id=\"Form_Upload_pane_Back\" class=\"Form_Upload_pane_Back\"><input value=\"OK\" type=\"button\" onmousedown=\"button_Form_UploadBack_down()\" onmousemove=\"button_Form_UploadBack_move()\" onmouseout=\"button_Form_UploadBack_out()\" onmouseup=\"button_Form_UploadBack_up()\"/></div>";
        }
}
    ...
    WalletUsed = false;
        document.getElementById("Form_Upload_pane_mess").innerHTML = "<br><br>Exiting, Please wait..."
        $("div").remove("#Form_Upload_pane_Back");
}
...
function button_Top_Language_up() {
    ...
    string += "<div class=\"Language_preview_pane_mess\"><label>Switching languages resets the project. whether to switched?</label></div>";
    string += "<div class=\"Language_preview_pane_BackYes\"><input value=\"Yes\" type=\"button\" onmousedown=\"button_Language_Top_BackYes_down()\" onmousemove=\"button_Language_Top_BackYes_move()\" onmouseout=\"button_Language_Top_BackYes_out()\" onmouseup=\"button_Language_Top_BackYes_up()\"/></div>";
    string += "<div class=\"Language_preview_pane_BackNo\"><input value=\"No\" type=\"button\" onmousedown=\"button_Language_Top_BackNo_down()\" onmousemove=\"button_Language_Top_BackNo_move()\" onmouseout=\"button_Language_Top_BackNo_out()\" onmouseup=\"button_Language_Top_BackNo_up()\"/></div>";
    string += "</div>";
