...
function ToHTML_House_Preview_Restore() {
    ...
    string += "<div class=\"House_Preview_Restore_Head\"><label>恢复项目</label></div>";
    string += "<div class=\"House_Preview_Restore_Key\"><label>项目编号:</label><input id=\"House_Preview_Restore_Key\" maxlength=\"20\" type=\"text\" /></div>";
    string += "<div class=\"House_Preview_Restore_Pass\"><label>项目密钥:</label><input id=\"House_Preview_Restore_Pass\" maxlength=\"20\" type=\"text\" /></div>";
    ...
    string += "<input value=\"恢复\" type=\"button\" onmousedown=\"button_House_Preview_Restore_Button_Restore_down()\" onmousemove=\"button_House_Preview_Restore_Button_Restore_move()\" onmouseout=\"button_House_Preview_Restore_Button_Restore_out()\" onmouseup=\"button_House_Preview_Restore_Button_Restore_up()\"/>";
    string += "</div>";
    string += "</div>";
...
function ToHTML_House_Preview_Result() {
    ...
    string += "<div class=\"House_Preview_Result_Head\"><label>查看结果</label></div>";
    string += "<div class=\"House_Preview_Result_Key\"><label>项目编号:</label><input id=\"House_Preview_Result_Key\" maxlength=\"20\" type=\"text\" /></div>";
    string += "<div class=\"House_Preview_Result_Pass\"><label>项目密钥:</label><input id=\"House_Preview_Result_Pass\" maxlength=\"20\" type=\"text\" /></div>";
    ...
    string += "<input value=\"确定\" type=\"button\" onmousedown=\"button_House_Preview_Result_Button_Result_down()\" onmousemove=\"button_House_Preview_Result_Button_Result_move()\" onmouseout=\"button_House_Preview_Result_Button_Result_out()\" onmouseup=\"button_House_Preview_Result_Button_Result_up()\"/>";
    string += "</div>";
    string += "</div>";
...
function ToHTML_House_Preview_Search() {
    ...
    string += "<div class=\"House_Preview_Search_Head\"><label>搜索表单</label></div>";
    string += "<div class=\"House_Preview_Search_Key\"><label>项目编号:</label><input id=\"House_Preview_Search_Key\" maxlength=\"20\" type=\"text\" /></div>";
    ...
    string += "<input value=\"搜索\" type=\"button\" onmousedown=\"button_House_Preview_Search_Button_Search_down()\" onmousemove=\"button_House_Preview_Search_Button_Search_move()\" onmouseout=\"button_House_Preview_Search_Button_Search_out()\" onmouseup=\"button_House_Preview_Search_Button_Search_up()\"/>";
    string += "</div>";
    string += "</div>";
...
function button_House_Preview_Restore_Button_Restore_up() {
    ...
    if (Key == ""|| Pass == "") {
        document.getElementById("House_Preview_Restore_Mess").innerHTML = "内容不能为空";
    }
    else if (Key.length != 20||Pass.length != 20) {
        document.getElementById("House_Preview_Restore_Mess").innerHTML = "内容格式有误";
    }
    else {
        document.getElementById("House_Preview_Restore_Mess").innerHTML = "正在查询数据";
...
function Restore_UploadData_Search(resp,Key,Pass) {
    ...
    if (result == "") {
        document.getElementById("House_Preview_Restore_Mess").innerHTML = "错误:调用合约失败";
    }
    else {
        try {
            result = JSON.parse(result)
        } catch (err) {
            document.getElementById("House_Preview_Restore_Mess").innerHTML = "JSON错误:" + err;
        }
        if (result.Value) {
            if (result.True) {
                document.getElementById("House_Preview_Restore_Mess").innerHTML = "";
                window.location.href = "dapp_edit.html?" + "status=" + encodeURI(2) + "&key=" + Key + "&value=" + Pass;
            }
            else {
                document.getElementById("House_Preview_Restore_Mess").innerHTML = result.Type + ":" + result.Value + "," + result.Info;
            }
        }
...
function button_House_Preview_Search_Button_Search_up() {
    ...
    if (Key == "") {
        document.getElementById("House_Preview_Search_Mess").innerHTML = "内容不能为空";
    }
    else if (Key.length != 20) {
        document.getElementById("House_Preview_Search_Mess").innerHTML = "内容格式有误";
    }
    else {
        document.getElementById("House_Preview_Search_Mess").innerHTML = "正在查询数据";
...
function Search_StorageData_Search(resp, Key) {
    var result = resp.result;
    if (result == "") {
        document.getElementById("House_Preview_Search_Mess").innerHTML = "错误:调用合约失败";
    }
    else {
        try {
            result = JSON.parse(result)
        } catch (err) {
            document.getElementById("House_Preview_Search_Mess").innerHTML = "JSON错误:" + err;
        }
        if (result.Value) {
            if (result.True) {
                document.getElementById("House_Preview_Search_Mess").innerHTML = "";
                window.location.href = "dapp_presentation.html?" + "key=" + Key;
            }
            else {
                document.getElementById("House_Preview_Search_Mess").innerHTML = result.Type + ":" + result.Value + "," + result.Info;
            }
        }
...
function button_House_Preview_Result_Button_Result_up() {
    ...
    if (Key == "" || Pass == "") {
        document.getElementById("House_Preview_Result_Mess").innerHTML = "内容不能为空";
    }
    else if (Key.length != 20 || Pass.length != 20) {
        document.getElementById("House_Preview_Result_Mess").innerHTML = "内容格式有误";
    }
    else {
        document.getElementById("House_Preview_Result_Mess").innerHTML = "正在查询数据";
...
function Result_ResultData_Search(resp, Key, Pass) {
    var result = resp.result;
    if (result == "") {
        document.getElementById("House_Preview_Result_Mess").innerHTML = "错误:调用合约失败";
    }
    else {
        try {
            result = JSON.parse(result)
        } catch (err) {
            document.getElementById("House_Preview_Result_Mess").innerHTML = "JSON错误:" + err;
        }
        if (result.Value) {
            if (result.True) {
                ...
                document.getElementById("House_Preview_Result_Mess").innerHTML = result.Type + ":" + result.Value + "," + result.Info;
            }
        }
