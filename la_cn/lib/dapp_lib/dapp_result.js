...
function Result_Then_Onload(key, value) {
    ...
    if (key.length == 20 && value.length == 20) {
        Result_Remind_Type1_Open("正在恢复数据", key, value);
    }
    else {
        Result_Remind_Type2_Open("地址错误,请检查你的链接");
    } 
...
function Result_Remind_Type1_Then(resp) {
    ...
    if (result == "") {
        document.getElementById("Result_Remind_pane_mess").innerHTML = "错误:调用合约失败";
        document.getElementById("Result_Remind_pane").innerHTML += "<div class=\"Result_Remind_pane_Button\"><input value=\"退出\" type=\"button\" onmousedown=\"button_Result_Remind_Type2_dowm()\" onmousemove=\"button_Result_Remind_Type2_move()\" onmouseout=\"button_Result_Remind_Type2_out()\" onmouseup=\"button_Result_Remind_Type2_up()\"/></div>";
    }
    else {
        try {
            result = JSON.parse(result)
        } catch (err) {
            document.getElementById("Result_Remind_pane_mess").innerHTML = "JSON错误:" + err;
            document.getElementById("Result_Remind_pane").innerHTML += "<div class=\"Result_Remind_pane_Button\"><input value=\"退出\" type=\"button\" onmousedown=\"button_Result_Remind_Type2_dowm()\" onmousemove=\"button_Result_Remind_Type2_move()\" onmouseout=\"button_Result_Remind_Type2_out()\" onmouseup=\"button_Result_Remind_Type2_up()\"/></div>";
        }
        if (result.Value) {
            if (result.True) {
                document.getElementById("Result_Remind_pane_mess").innerHTML = "合约中存在一个错误,请联系我们";
                document.getElementById("Result_Remind_pane").innerHTML += "<div class=\"Result_Remind_pane_Button\"><input value=\"退出\" type=\"button\" onmousedown=\"button_Result_Remind_Type2_dowm()\" onmousemove=\"button_Result_Remind_Type2_move()\" onmouseout=\"button_Result_Remind_Type2_out()\" onmouseup=\"button_Result_Remind_Type2_up()\"/></div>";
            }
            else {
                document.getElementById("Result_Remind_pane_mess").innerHTML = result.Type + ":" + result.Value + "," + result.Info;
                document.getElementById("Result_Remind_pane").innerHTML += "<div class=\"Result_Remind_pane_Button\"><input value=\"退出\" type=\"button\" onmousedown=\"button_Result_Remind_Type2_dowm()\" onmousemove=\"button_Result_Remind_Type2_move()\" onmouseout=\"button_Result_Remind_Type2_out()\" onmouseup=\"button_Result_Remind_Type2_up()\"/></div>";
            }
        }
        else if (result.Key) {
            ...
            document.getElementById("Result_Remind_pane_mess").innerHTML = "错误:" + result;
            document.getElementById("Result_Remind_pane").innerHTML += "<div class=\"Result_Remind_pane_Button\"><input value=\"退出\" type=\"button\" onmousedown=\"button_Result_Remind_Type2_dowm()\" onmousemove=\"button_Result_Remind_Type2_move()\" onmouseout=\"button_Result_Remind_Type2_out()\" onmouseup=\"button_Result_Remind_Type2_up()\"/></div>";
        }
    }
}
function Result_Remind_Type2_Open(str) {
    ...
    string += "<div class=\"Result_Remind_pane_Head\"></div>";
    string += "<div class=\"Result_Remind_pane_mess\"><label id=\"Result_Remind_pane_mess\">" + str + "</label></div>";
    string += "<div class=\"Result_Remind_pane_Button\"><input value=\"退出\" type=\"button\" onmousedown=\"button_Result_Remind_Type2_dowm()\" onmousemove=\"button_Result_Remind_Type2_move()\" onmouseout=\"button_Result_Remind_Type2_out()\" onmouseup=\"button_Result_Remind_Type2_up()\"/></div>";
    string += "</div>";
...
function HTML_Result_Updata() {
    ...
    string += "</div>";
    string += "<div class=\"Result_form_button_submit\"><input id=\"button_submit\" type=\"button\" value=\"退出\" onmousedown=\"button_Result_sumbit_down()\" onmousemove=\"button_Result_sumbit_move()\" onmouseout=\"button_Result_sumbit_out()\" onmouseup=\"button_Result_sumbit_up()\" /></div>";
...
function ToHTML_Result_MainTitle(object) {
    ...
    string += "<div id=\"Result_form_MainTitle_title\" class=\"Result_form_MainTitle_title\"><label   id=\"Result_form_MainTitle_title\">" + object.Title + " (" + Result.Submit_Num + "次)" + "</label></div>";
...
function ToHTML_Result_Multiple(object) {
    ...
    string += "<div class=\"Result_form_Project__Head\"><div class=\"Result_form_Project__Head_Type\"><label>" + object.No + ": 多选项" + GetMultipleNumString_Result(object) + "</label></div></div>";
...
function ToHTML_Result_Single(object) {
    var string = "";
    string += "<div class=\"Result_form_Project\">";
    string += "<div class=\"Result_form_Project__Head\"><div class=\"Result_form_Project__Head_Type\"><label>" + object.No + ": 单选项</label></div></div>";
...
function ToHTML_Result_Text(object) {
    ...
    string += "<div class=\"Result_form_Project__Head_Type\"><label>" + object.No + ": 文本项</label></div>";
    string += "</div>";
    ...
    string += "<label id=\"Result_form_Project_Text_Page_Next_" + object.Coding + "\" class=\"Result_form_Project_Text_Page_Next\" onmousedown=\"button_Result_form_Project_Text_Page_Next_down(" + object.Coding + ")\" onmousemove=\"button_Result_form_Project_Text_Page_Next_move(" + object.Coding + ")\" onmouseout=\"button_Result_form_Project_Text_Page_Next_out(" + object.Coding + ")\" onmouseup=\"button_Result_form_Project_Text_Page_Next_up(" + object.Coding + ")\">下一条</label>";
    string += "</div >";
    string += "</div>";
    string += "</div>";
    return string;
...
function button_Result_Top_House_up() {
    ...
    string += "<div class=\"Result_House_pane_mess\"><label><div class=\"Result_None_Select\">正在查看结果,是否退出?</div></label></div>";
    string += "<div class=\"Result_House_pane_BackYes\"><input value=\"确定\" type=\"button\" onmousedown=\"button_Result_Top_House_BackYes_down()\" onmousemove=\"button_Result_Top_House_BackYes_move()\" onmouseout=\"button_Result_Top_House_BackYes_out()\" onmouseup=\"button_Result_Top_House_BackYes_up()\"/></div>";
    string += "<div class=\"Result_House_pane_BackNo\"><input value=\"取消\" type=\"button\" onmousedown=\"button_Result_Top_House_BackNo_down()\" onmousemove=\"button_Result_Top_House_BackNo_move()\" onmouseout=\"button_Result_Top_House_BackNo_out()\" onmouseup=\"button_Result_Top_House_BackNo_up()\"/></div>";
    string += "</div>";
